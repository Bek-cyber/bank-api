...
**Bank API** — учебно-практический backend-сервис, имитирующий банковскую систему счетов и транзакций.
...
├── exception         # Модель ошибок и глобальный handler
└── BankApiApplication
```
---
...
- Добавлены индексы под реальные бизнес-запросы:
  ...
  - idempotency-ключи
- Нет избыточных индексов и преждевременной оптимизации
